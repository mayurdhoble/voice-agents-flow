    ...
    <div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
      <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={onClose} className="text-gray-400 hover:text-gray-700 text-lg font-light">✕</button>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              {data.data.map(row => (
                ...
                >
                  <td className="px-6 py-3.5 font-medium text-gray-800">{row.guest_name || '—'}</td>
                  <td className="px-6 py-3.5 text-gray-500 text-xs font-mono">{row.phone}</td>
                  <td className="px-6 py-3.5 text-gray-500">{row.message_count}</td>
                  <td className="px-6 py-3.5">
                    {row.booking_done
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-0.5">Bot conversations and sent notifications</p>
      </div>
