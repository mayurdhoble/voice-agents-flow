...
const links = [
  ...
  { to: '/usage',     label: 'Usage',      Icon: CurrencyIcon },
    ...
    <aside className="w-60 bg-gray-950 flex flex-col h-full shrink-0 border-r border-gray-800">
      ...
      <div className="px-5 py-5 border-b border-gray-800">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="text-white font-semibold text-sm leading-none">Lotus Sutra</p>
            <p className="text-gray-500 text-xs mt-0.5">Voice Dashboard</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-3 py-4 border-t border-gray-800 space-y-0.5">
        <p className="px-3 pb-1.5 text-[10px] font-semibold text-gray-600 uppercase tracking-widest">Goa, India</p>
        <button
